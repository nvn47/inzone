	...
	function init(){
		...
		play.bind('click', function() {
			if($(this).hasClass('pause')) {
				...
				intervalID = setInterval("$('#next').trigger('click')", 4000);
			}
